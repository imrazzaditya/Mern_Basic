...
// //Ques1 : make a seperate array which only has name and cuisine int it ,
// // print it on console using for loop for each and map in Js
...
//Ques2: Filter items having  rating >4.5


const {recipes} = data;
const filtteredarray = recipes.filter((item) => {
const {rating} = item;
...
const finalarr = filtteredarray.map((item)=>{
    const {name,cuisine} = item;
    return {
        name,
        cuisine,
    }
